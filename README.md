...
The `results` folder contains all the intermediate files generated by each step of the framework. Each step creates its own folder to keep everything more clear and easy to find. This folder has some subfolders that have the outputs of each script/step, for more information please refer to its [README](./results/README.md) file.
